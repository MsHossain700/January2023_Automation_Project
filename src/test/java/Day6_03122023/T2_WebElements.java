...
public class T2_WebElements {
    public static void main(String[] args) throws InterruptedException {
        ...
        // clear the and auto-populated data from purchase price
        ...
        //if you want you can use findElement as a webElement variable, you need to store it as an Array List
