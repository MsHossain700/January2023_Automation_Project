...
public class InClassActionItem {
    public static void main(String[] args) throws InterruptedException {
        ...
        //creating an ArrayList for number of adults
        ...
        //create a for loop for hotels.com, choose destinations and number of travelers
        for(int i = 0; i < Destinations.size(); i++){
            ...
            //create a WebElement for the first search box xpath
            WebElement destCountry = driver.findElement(By.xpath("//*[@class='uitk-fake-input uitk-form-field-trigger']"));

            //create a try/catch to select the first search box
            try {
                destCountry.click();
                Thread.sleep(1000);
            ...
            //create a try/catch for clicking on the first result
            try {
            ...
            //create a WebElement to select on the Travelers search box
            WebElement travelerCount = driver.findElement(By.xpath("//*[@data-stid='open-room-picker']"));

            //create a Try/Catch for clicking on the Travelers search box
            try {
                travelerCount.click();
            ...
            //create a WebElement for the increase child age by 1 button
            ...
            //create a Try/Catch for increasing child age by 1
            try {
            ...
            //create a WebElement for the increase adult age by 1 button
            ...
            for (int j = 0; j < adults.get(i); j++) {
                ...
                //create a Try/Catch for increasing adult age by 1
                try {
            ...
            //create a Try/Catch for clicking on a search button
            try {
            ...
            //create a ArrayList to store links as a WebElement
            ...
            //create a Try/Catch for retrieving the hotel name
            try {
                ...
                System.out.println("Unable to retrieve the hotel name" + k);
            }

            Thread.sleep(3000);

            //create a Try/Catch for clicking on the Reserve a Room button
            try {
                ...
                System.out.println("Unable to click on Reserve a Room" + l);
            }

            Thread.sleep(1000);

            //create a Try/Catch for retrieving the price per night for the hotel
            try {
                ...
                System.out.println("Unable to retrieve the price per night for the hotel" + m);
            }

            Thread.sleep(1000);

            //create a Try/Catch for clicking on the Reserve button
            try {
                ...
                System.out.println("Unable to click on the Reserve button" + n);
            }

            Thread.sleep(3000);

            //create a Try/Catch for clicking on the Pay Now button
            try {
                ...
                System.out.println("Unable to click on the Pay Now button" + o);
            }

            Thread.sleep(1000);

            //create a Try/Catch for retrieving the check-in date
            try {
                ...
                System.out.println("Unable to retrieve the check-in date" + p);
            }

            Thread.sleep(1000);

            //create a Try/Catch for retrieving the check-out date
            try {
                ...
                System.out.println("Unable to retrieve the check-out date" + q);
            }
